...
-- AddForeignKey
ALTER TABLE "WarRoomSession" ADD CONSTRAINT "WarRoomSession_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DebateMessage" ADD CONSTRAINT "DebateMessage_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "WarRoomSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AssumptionNode" ADD CONSTRAINT "AssumptionNode_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "WarRoomSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AdvisorMessage" ADD CONSTRAINT "AdvisorMessage_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "WarRoomSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;
