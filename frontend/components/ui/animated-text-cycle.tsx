...
export default function AnimatedTextCycle({
  ...
  // Reduced motion: swap the word in place with no blur/slide/width spring.
  ...
  return (
    <>
      {/* Hidden measurement element with all words rendered (span-only so it is
          valid phrasing content inside a heading). */}
      <span
        ref={measureRef}
        aria-hidden="true"
